...
public class AddActivity extends Activity {
    ...
    private static String IMG_PATH = getSDPath() + java.io.File.separator
            + "ocrtest";
    private static String TESSDATA_PATH = "/storage/extSdCard/";
		...
		public void handleMessage(Message msg){
			switch (msg.what){
				case 1:
					...
					if(success){
						Toast.makeText(AddActivity.this, "登录成功", Toast.LENGTH_SHORT).show();
						Intent i = new Intent(AddActivity.this,MainActivity.class);
						startActivity(i);
					}else if (str=="该账号未被注册"){
						Toast.makeText(AddActivity.this, "该账号未被注册", Toast.LENGTH_SHORT).show();
					}
					else{
						Toast.makeText(AddActivity.this, "密码错误", Toast.LENGTH_SHORT).show();
					}
					break;
				default:
					break;
		...
		new Thread(new Runnable(){
    		public void run(){
    			...
    			try{
    				...
    				out.writeBytes("pname="+pname+"&cont="+cont);
